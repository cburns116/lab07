...
$("#answer").click(function(){
    //do the math here
    //percentage off = (|expected - actual|/225)*100
    //score = calculate ((15-dificultly-percent_off) / (15 - dificulty))*(15000-miliseconds taken))
    //add score to total score
    //display the score as a running tally
    //check to see if used all turns and display final score
